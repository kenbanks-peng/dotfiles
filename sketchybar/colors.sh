...
export WORKSPACE_BACKGROUND=0xff2c2e4e
export WORKSPACE_FOREGROUND=$TEXT
export WORKSPACE_FOCUSED_BACKGROUND=0xff0070c0
export WORKSPACE_FOCUSED_FOREGROUND=$ON